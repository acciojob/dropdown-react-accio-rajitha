...
function App() {
  ...
  return (
    <div id="main">
      ...
      <div>
        <h2>Details</h2>
        <p><strong>State:</strong> {normalizeText(selectedState.name)}</p>
        <p><strong>City:</strong> {normalizeText(selectedCity.name)}</p>
        <p><strong>Landmark:</strong> {normalizeText(selectedLandmark.name)}</p>
        <p><strong>Description:</strong> {normalizeText(selectedLandmark.description)}</p>
      </div>
    </div>
  );
}
