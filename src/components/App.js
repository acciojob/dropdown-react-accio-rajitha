...
const states = [
	{
	  ...
	  city: [
		...
		{
			name: "Bhopal",
			description: "Bhopal is a city in the central Indian state of Madhya Pradesh. It is one of India’s greenest cities. There are two main lakes, the Upper Lake and the Lower Lake.",
			landmarks: [
			  {
				name: "MANIT",
	...
	},
	{
	  ...
	  city: [
		...
		{
		  name: "Tezpur",
		  description: "Tezpur is a landmark and urban agglomeration in Sonitpur district, Assam state, India. Tezpur is located on the banks of the river Brahmaputra, 175 kilometres northeast of Guwahati.",
		  landmarks: [
			{
			  name: "Bamuni Hills",
			  description: "Best location for photoshoots.",
	  ...
	  city: [
		{
		  ...
		  landmarks: [
			...
			{
			  name: "Maner",
			  description: "Maner also spelled Maner or Maner Sharif, is a satellite landmark in Patna Metropolitan Region, in the Patna district in the Indian state of Bihar.",
			},
		  ],
		},
		{
		  name: "Gaya",
		  description: "Gaya is a holy city beside the Falgu River, in the northeast Indian state of Bihar. It is known for the 18th-century Vishnupad Mandir, a riverside temple with an octagonal shrine.",
		  landmarks: [
			{
			  name: "Bakraur",
			  description: "Bakraur, sometimes called Bakrour, is a village located slightly east of Bodh Gaya in the state of Bihar, India.",
			},
			{
			  name: "Barachatti",
